...
- (void) createAccount:(NSString*)username displayName: (NSString*) displayName domain: (NSString*) domain pwd: (NSString*) pwd{
    ...
    linphone_proxy_config_set_route(
                                    config,
                                    [NSString stringWithFormat:@"%s;transport=%s", domain.UTF8String, "tcp"]
                                    .UTF8String);
...
- (void)foo:(NSString*)username displayName: (NSString*) displayName domain: (NSString*) domain pwd: (NSString*) pwd;{
    
}

- (IBAction)onLoginClick:(id)sender {
    [LinphoneUtils createAccount: @"1234" displayName: @"1234" domain: @"test.linphone.org" pwd: @""];
//	ONCLICKBUTTON(sender, 100, {
//		_waitView.hidden = NO;
