...
+ (void)setDisplayNameLabel:(UILabel *)label forContact:(Contact *)contact {
    label.text = [CallManager.instance convertAddressWithAddress:(contact.displayName)];
...
+ (void)setDisplayNameLabel:(UILabel *)label forAddress:(const LinphoneAddress *)addr {
	...
	if (contact) {
        ...
        label.text = [CallManager.instance convertAddressWithAddress:([FastAddressBook displayNameForAddress:addr])];
	}
}
